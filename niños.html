...
<body>
    <header>
        ...
        <div>
            <a href="mujeres.php" style="margin-right: 10px;"><span style="margin-right: 10px;">Mujeres</span></a>
            <a href="ninos.php"><span style="margin-right: 10px;">Niños</span></a>
        </div>
    </header>
    <div id="products">
    ...
    <script>
        ...
        var products = [
            {name: "TENDER MOMENTS NUBE", price: 441.00, description: "Fragance: Floral Madersa", image: "img/n1.jpg"},
            {name: "SKID ROCK", price: 256.00, description: "Fragance: Foguere Marina Maderosa", image: "img/n2.jpg"},
            {name: "BITBLOX", price: 441.00, description: "Fragance: Floriental Fratal", image: "img/n3.jpg"},
            {name: "TENDER MOMENTS ONE 2 FOUR", price: 234.00, description: "Fragance: Floriall Frutal", image: "img/n4.jpg"},
            {name: "CORETA", price: 256.00, description: "Fragance: Floral Fruatl", image: "img/n5.jpg"},
            {name: "SKID ROCK", price: 256.00, description: "Fragance: Foguere Marina Maderosa", image: "img/n6.jpg"},
            {name: "CHIPS AHOY", price: 357.00, description: "Fragance: Floral Frutal", image: "img/n7.jpg"},
            {name: "CHIPS AHOY", price: 357.00, description: "Fragance: Floral Madersa", image: "img/n8.jpg"},
            {name: "CORETA", price: 256.00, description: "Fragance: Floral Frutal", image: "img/n9.jpg"}
        ];
