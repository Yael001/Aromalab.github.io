...
<body>
    ...
    <script>
        ...
        var products = [
            {name: "JF9", price: 719.00, description: "Fragance: Fougere Fresca Maderosa", image: "img/h1.jpg"},
            {name: "XCLUSIVE SPEED", price: 382.00, description: "Fragance: Oriental Speciada Maderosa", image: "img/h2.jpg"},
            {name: "AEQUOR", price: 574.00, description: "Fragance: Maderosa Acuatica", image: "img/h3.jpg"},
            {name: "EAU d´ AROMES HOMME", price: 375.00, description: "Fragance: Critica Aromatica Acuosa", image: "img/h4.jpg"},
            {name: "J-SPORT RIDE", price: 513.00, description: "Fragance: Aromatica Maderosa Foguere", image: "img/h5.jpg"},
            {name: "EAU D´AROMES HOMME LIBRE", price: 626.00, description: "Fragancie: Aromatica Tonica Critica", image: "img/h6.jpg"},
            {name: "NAVIGO LUXUS HOME", price: 456.00, description: "Fragance: Vegana", image: "img/h7.jpg"},
            {name: "BLAZON", price: 543.00, description: "Fragance: Oriental Herfacea", image: "img/h8.jpg"},
            {name: "JF9 CHROME", price: 719.00, description: "Fragance: Fougere Maderosa Aromatica", image: "img/h9.jpg"}
        ];
